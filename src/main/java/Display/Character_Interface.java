...
public class Character_Interface extends JLayeredPane {
    ...
    public void mark(Character c) {
        mark[team.indexOf(c)] = true;
    }

    public void unmark(Character c) {
        mark[team.indexOf(c)] = false;
    }
}
